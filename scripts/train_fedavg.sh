#!/bin/bash
#SBATCH --job-name=FL_training
#SBATCH --output=/net/scratch/kballantyne/msds_final/logs/%j.%N.stdout
#SBATCH --error=/net/scratch/kballantyne/msds_final/logs/%j.%N.stderr
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=kballantyne@cs.uchicago.edu
#SBATCH --chdir=/home/kballantyne/msds_final/scripts
